...
class WandbGoTracker:
    ...
    def initialize_run(self, config: Dict[str, Any],
        ...
        default_config = {
            ...
            "filters": 31,
            "expansion_factor": config['model']['factor'],
            "squeeze_excitation": config['model']['se'],
            ...
            "cosine_cycles": config['train']['nb_cosinedecay_cycle'],
            "policy_weight": config['train']['policy_weight'],
            "value_weight": config['train']['value_weight'],
            "optimizer": "AdamW",
            "clipnorm": config['train']['clipnorm_lr'],

            # Configuration des données
            "dataset_size": config['train']['N'],
            "input_shape": [19, 19, 31],
            "num_classes": 361,
            "data_augmentation": f"{config['augmentation']['nb_rotation']}-fold_symmetry",

            # Métriques de performance
            "target_policy_accuracy": 0.45,
            "target_value_mse": 0.10,
