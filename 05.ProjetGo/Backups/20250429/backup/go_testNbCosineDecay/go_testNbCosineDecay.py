...
def test_gomobilenet(nb_cycle, epochs=EPOCHS):
    ...
    return f'Model MobileNet - Nb CosineDecay Cycle is {nb_cycle}', model, val, all_history, val_loss_history, total_time, lrs
...
if __name__ == "__main__":
    ...
    loss_history = []
    titles = []
    for nb_cycle in [1, 3, 5, 7, 10]:
        print(f'-------------------- Model MobileNet - Nb CosineDecay Cycle is {nb_cycle} -------------------- ')
