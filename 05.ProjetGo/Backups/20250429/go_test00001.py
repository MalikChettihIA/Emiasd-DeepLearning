...
def test_goresnet(config):
    config['experiment_name'] = 'Test00001-ResNet'
...
def test_gomobilenet(config):
    config['experiment_name'] = 'Test00001-MobileNet'
...
def test_gomixnet(config):
    config['experiment_name'] = 'Test00001-MixNet'
...
if __name__ == "__main__":
    ...
    #print(f'-------------------- Model GoResNet -------------------- ')
    #title, model, val, all_history, val_loss_history, total_time, lrs = test_goresnet(config=CONFIG)
    ...
    print(f'-------------------- Model GoMixNet -------------------- ')
    title, model, val, all_history, val_loss_history, total_time, lrs = test_gomixnet(config=CONFIG)
    plot_learning_rate(lrs)
