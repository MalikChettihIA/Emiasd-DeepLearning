...
CONFIG = {
    'entity': 'Emiasd',
    'project': 'GoProject',
    'experiment_name': 'Test-GradCliping',
    'model': {
        'type':'GoMobilNet',
        'block_num': 7,
        'kernel_size': (3,3),
...
if __name__ == "__main__":
    ...
    for clipnorm_lr in [0.5, 1.0, 2.0]:
        print(f'-------------------- {CONFIG["experiment_name"]}  -------------------- ')

        CONFIG['train']['clipnorm_lr'] = clipnorm_lr
        CONFIG['experiment_name'] = f'{experiment_name}-{clipnorm_lr}'
