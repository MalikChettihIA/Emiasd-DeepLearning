...
def test_gomobilenet( epochs=EPOCHS):
    ...
    val, all_history, val_loss_history, total_time, lrs = train_model(
        ...
        block_num=8, filters=32, factor=4, se=True, drop_out_rate=0.0, activation='swish', experiment_name='Test4'
    )
    return (f'Model GoMobileNet block_num=8 , filters=32, initial_lr=0.001'), model, val, all_history, val_loss_history, total_time, lrs
