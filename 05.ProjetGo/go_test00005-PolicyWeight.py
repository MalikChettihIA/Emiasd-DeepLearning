...
CONFIG = {
    'entity': 'Emiasd',
    'project': 'GoProject',
    'experiment_name': 'Test-PolicyWeight',
    'run':'0001',
    'model': {
        'type': 'GoMobilNet',
        'block_num': 7,
...
if __name__ == "__main__":
    ...
    for policy_weight in [10, 20, 30]:

        CONFIG['experiment_name'] = f'{CONFIG["experiment_name"]}-{policy_weight}'
        CONFIG['train']['policy_weight'] = policy_weight
