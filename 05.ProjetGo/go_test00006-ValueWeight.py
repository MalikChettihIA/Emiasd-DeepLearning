...
CONFIG = {
    'entity': 'Emiasd',
    'project': 'GoProject',
    'experiment_name': 'Test-ValueWeight',
    'run':'0001',
    'model': {
        'type': 'GoMobilNet',
        'block_num': 7,
...
if __name__ == "__main__":
    ...
    for value_weight in [2,4,6,8]:

        CONFIG['experiment_name'] = f'{experiment_name}-{value_weight}'
        CONFIG['train']['value_weight'] = value_weight
